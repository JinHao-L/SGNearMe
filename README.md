...
1. Starting the bot - `/start` and select `📍Share Location`  
    <img src="./images/start.jpg" width="500"/>

1. Selecting a category - `/menu` to manually bring up the categories menu  
    <img src="./images/categories.jpg" width="500"/>

1. Selecting a search query  
    <img src="./images/education.jpg" width="500"/>
...
1. Show a OneMap map image (night mode) - `/map`  
    Example map:  
    <img src="https://developers.onemap.sg/commonapi/staticmap/getStaticImage?layerchosen=night&lat=1.31955&lng=103.84223&zoom=17&height=512&width=512" width="500"/>
